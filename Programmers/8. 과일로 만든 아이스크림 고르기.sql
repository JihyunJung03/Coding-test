...
# 상반기 3000보다 높으면서 과일인 맛 
# 주문량이 큰 순서대로 
# INGREDIENT_TYPE에서 아이스크림의 주 성분이 설탕이면 sugar_based 과일이면 fruit_based
# ICECREAM_INFO의 기본 키(PK)는 FLAVOR 
# ICECREAM_INFO테이블의 FLAVOR는 FIRST_HALF 테이블의 FLAVOR의 외래 키(FK)
